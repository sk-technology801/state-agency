...
// ./src/app/resources/license-application/page.jsx
"use client";
...
const submitForm = async (formData) => {
  ...
  return { success: true, message: "License application submitted successfully!" };
};
...
// License Application Form Component
function LicenseApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ fullName: "", email: "", businessName: "", licenseType: "", document: null });
    } catch (error) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-white mb-6 text-center">License Application</h2>
      <form onSubmit={handleSubmit} className="space-y-4" encType="multipart/form-data">
        ...
        <div>
          <label htmlFor="licenseType" className="block text-sm font-medium text-gray-200">
            License Type
          </label>
          <select
            id="licenseType"
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 text-gray-900">
        ...
        <section className="relative bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-20">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Apply for a state license online or download the form for offline submission.
            </motion.p>
            <motion.div
            ...
            >
              <Link
                ...
                aria-label="Go to license application form"
              >
                Start Application
              </Link>
            </motion.div>

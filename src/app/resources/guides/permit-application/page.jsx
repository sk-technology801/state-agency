...
// ./src/app/resources/permit-application/page.jsx
"use client";
...
const submitForm = async (formData) => {
  ...
  return { success: true, message: "Permit application submitted successfully!" };
};
...
// Permit Application Form Component
function PermitApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("permitType", formData.permitType);
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-white mb-6 text-center">Permit Application</h2>
      <form onSubmit={handleSubmit} className="space-y-4" encType="multipart/form-data">
        <div>
          <label htmlFor="applicantName" className="block text-sm font-medium text-gray-200">
            Applicant Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="permitType" className="block text-sm font-medium text-gray-200">
            Permit Type
          </label>
          <select
            id="permitType"
      ...
      <div className="mt-4 text-center">
        <Link
          ...
          aria-label="Download permit application form"
        >
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 text-gray-900">
        ...
        <section className="relative bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-20">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Apply for a state permit online or download the form for offline submission.
            </motion.p>
            <motion.div
            ...
            >
              <Link
                ...
                aria-label="Go to permit application form"
              >
                Start Application
              </Link>
            </motion.div>
        ...
        {/* Form Section */}
        <section id="permit-form" className="py-16">

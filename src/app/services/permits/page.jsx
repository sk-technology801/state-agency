...
// Mock API for permit types (replace with real API call in production)
const fetchPermitTypes = async () => {
  await new Promise((resolve) => setTimeout(resolve, 1000)); // Simulate API delay
  return [
    { id: 1, name: "Building Permit", description: "Apply for construction or renovation permits." },
    { id: 2, name: "Event Permit", description: "Obtain permits for public events or gatherings." },
    { id: 3, name: "Zoning Permit", description: "Secure permits for land use and zoning compliance." },
    { id: 4, name: "Environmental Permit", description: "Apply for permits related to environmental regulations." },
  ];
};
...
// Permit Selection Component
function PermitSelection({ onSelect }) {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {permitTypes.map((permit) => (
        <motion.div
          ...
          transition={{ duration: 0.5, delay: permit.id * 0.1 }}
        >
          <button
          ...
          >
            ...
            <div className="relative z-10">
              <Building className="w-12 h-12 text-blue-600 mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 text-gray-900">{permit.name}</h3>
...
function ApplicationForm({ selectedPermit, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!formData.applicantName || !formData.email || !formData.projectDetails) {
    ...
    return (
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600">
          Your {selectedPermit.name} application has been submitted successfully.
        </p>
        <Link
          href="/services"
          className="mt-4 inline-block bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition"
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
      <h3 className="text-2xl font-bold mb-6 text-gray-900">Apply for {selectedPermit.name}</h3>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          aria-label={`Submit ${selectedPermit.name} application`}
        >
          Submit Application
        </button>
      </form>
...
export default function PermitsPage() {
  ...
  const handleSubmit = (formData) => {
    ...
    console.log("Form submitted:", formData, selectedPermit);
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 text-gray-900">
        ...
        <section className="relative bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-20">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Apply for state permits quickly and securely online.
            </motion.p>
            <motion.div
            ...
            >
              <Link
                ...
                aria-label="Start permit application"
              >
                Start Application
              </Link>
            </motion.div>
        ...
        <section id="apply" className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12">
              {selectedPermit ? `Apply for ${selectedPermit.name}` : "Select a Permit Type"}
            </h2>
            <Suspense fallback={<div>Loading permit types...</div>}>
              {selectedPermit ? (
                <ApplicationForm selectedPermit={selectedPermit} onSubmit={handleSubmit} />
              ) : (
                <PermitSelection onSelect={setSelectedPermit} />
              )}
            </Suspense>
          </div>
        </section>
        ...
        <section className="bg-blue-950 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Contact our support team for help with your permit application or explore our FAQ.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
